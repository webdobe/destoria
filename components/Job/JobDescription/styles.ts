...
const styles = {
    ...
    jobDescriptionBoxFormContent: "text-left w-full py-8 pb-5 md:pb-10",
    ...
    contactFormMessages: "w-full row pt-5 md:pt-10 text-center",
    ...
    gridForm: "flex flex-col md:grid md:grid-cols-2 pb-5 gap-4 w-full",
