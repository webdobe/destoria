...
const styles = {
    charactersCarousel: "w-full flex flex-col justify-center text-dwhite items-center text-dwhite bg-no-repeat bg-cover bg-characters pointer-events-none relative",
    ...
    charactersContent: "flex flex-col lg:flex-row text-dwhite gap-5 max-w-4xl",
    ...
    charactersTextContentTitle: "text-dhOrange text-base uppercase tracking-widest text-left",
    charactersTextContentSubtitle: "font-bold capitalize tracking-wide text-4xl py-4 text-left",
    charactersTextContentText: "text-base tracking-wide pb-5 text-left",
