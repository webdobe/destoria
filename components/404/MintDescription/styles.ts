...
const styles = {
    ...
    mintDescriptionTitle: "py-16 md:py-0 text-2xl text-dhOrange tracking-widest max-w-4xl",
    mintDescriptionBox: "flex flex-col justify-between w-full max-w-5xl m-auto md:mt-28 job-description-box p-8 mb-5",
